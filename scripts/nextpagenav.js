if (!jQuery) {
	...
	jQs.src = "https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.3/jquery.min.js";
	jQs.onload = insertKeybinds;
	document.body.appendChild(jQs);
} else {
	insertKeybinds();
}

function insertKeybinds() {
	// jQuery.query...
	...
	jQuery(document).keydown(function(e) {
		switch(e.which) {
			case 37: // left
				var currPage = jQuery.query.keys.page;
				currPage--;
				window.location.search = jQuery.query.set("page", currPage);
				break;
